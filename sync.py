    ...
    try:
        ...
        for _, row in df_med.iterrows():
            ...
            if sku in shop_by_sku:
                ...
                # NOTA: La antigua "protección anti-sobrescritura del 50%" se eliminó.
                # El precio manual ahora se protege de forma explícita y permanente con
                # el tag PRECIO_FIJO (verificado al inicio del loop). Sin ese tag, el
                # motor manda siempre: el precio recalculado se aplica directo.
